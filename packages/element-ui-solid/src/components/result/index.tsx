...
export interface IResultProps {
  ...
  icon?: "info" | "success" | "error" | "warning" | JSX.Element;
  extra?: JSX.Element;
}
export let Result: Component<IResultProps> = (inProps) => {
  ...
  return (
    <>
      <StyledResult class="el-result">
        <div class="el-result__icon">
          <Show when={props.icon}>
            <Switch fallback={<>{props.icon}</>}>
              <Match when={props.icon === "info"}>
                <IconInfo class="icon-info" />
              </Match>
              <Match when={props.icon === "success"}>
                <IconInfo class="icon-success" />
              </Match>
              <Match when={props.icon === "error"}>
                <IconInfo class="icon-error" />
              </Match>
              <Match when={props.icon === "warning"}>
                <IconInfo class="icon-warning" />
              </Match>
            </Switch>
          </Show>
        </div>
        <Show when={props.title}>
          <div class="el-result__title">{props.title}</div>
        </Show>

        <Show when={props.subTitle}>
          <div class="el-result__subtitle">{props.subTitle}</div>
        </Show>
        <Show when={props.extra}>
          <div class="el-result__extra">{props.extra}</div>
        </Show>
      </StyledResult>
    </>
  );
...
export let IconError = (props: { class?: string }) => (
...
export let IconInfo = (props: { class?: string }) => (
  <svg class={props.class} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
...
export let IconSuccess = (props: { class?: string }) => (
  <svg class={props.class} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
...
export let IconWarning = (props: { class?: string }) => (
  <svg class={props.class} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
